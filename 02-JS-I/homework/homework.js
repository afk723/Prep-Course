...
function redondearHaciaArriba(num) {
  ...
  // Tu código:
  var rendonarriba = Math.ceil(num);
  return rendonarriba;
}
...
function esPositivo(numero) {
  ...
  var StringPositivo = "Es positivo";
  var StringNegativo = "Es negativo";
  var esCero = false;

  if(numero > 0){
    return StringPositivo;
  }
  else if(numero < 0){
    return StringNegativo;
  }
  else {
    return esCero;
  }
