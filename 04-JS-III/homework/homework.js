...
function cuentoElementos(arreglo) {
  ...
  //segunda forma agregando elementos al array y devolviendo su longitud
  var newArr = [];
...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  var numgrande = arreglo[0];
  for (var i = 1; i < arreglo.length; i++) {
    if ((arreglo[i]) == (numgrande)) {
      return true;
    }
    else {
      return false;
...
function mesesDelAño(array) {
  ...
  var arrnuevo = [];
  for (var i = 0; i < array.length; i++) {
    if (String(array[i]).startsWith("Enero") || array[i] == "Marzo" || array[i] == "Noviembre") {
